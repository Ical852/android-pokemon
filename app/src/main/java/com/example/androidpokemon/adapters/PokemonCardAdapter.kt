...
class PokemonCardAdapter(
    private val pokemons: ArrayList<PokemonResultModel>,
    private val onClick: (PokemonResultModel) -> Unit
): RecyclerView.Adapter<PokemonCardAdapter.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        drawable.setColor(Color.parseColor(Utils().getPokeColor(
        ...
        holder.binding.pokemonName.text = Utils().capitalize(pokemon.name!!)
    ...
    fun updateData(data: List<PokemonResultModel>) {
        pokemons.clear()
